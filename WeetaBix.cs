namespace Eco.Mods.TechTree
{
    ...
    [Serialized]
    [Weight(300)]
    public partial class WeetaBixItem : //Name of the item in unity @DO NOT CHANGE USE A DIFFERENT NAME FROM THE UNITY VERSION
        FoodItem
    {
    ...
    public partial class WeetaBixRecipe : Recipe // "WeetaBixRecipe : Recipe" labels the name of the recipe that will be displayed in the workbench.
    {
        public WeetaBixRecipe() // include the same name as the food you are attempting to create before recipe eg, yourfoodrecipe()
        {
            this.Products = new CraftingElement[] // dont touch this
            {
                new CraftingElement<WeetaBixItem>(), //This is what the recipe will produce this one should be the name of your fooditem
            ...
            {
                new CraftingElement<RiceMilkItem>(typeof(HomeCookingEfficiencySkill), 5, HomeCookingEfficiencySkill.MultiplicativeStrategy),  //this is 1 element of crafting see below for more acurate annotation
            ...
            //copied & Pasted
                new CraftingElement<WheatItem>(typeof(HomeCookingEfficiencySkill), 4, HomeCookingEfficiencySkill.MultiplicativeStrategy),


            };
            this.CraftMinutes = CreateCraftTimeValue(typeof(WeetaBixRecipe), Item.Get<WeetaBixItem>().UILink(), 10, typeof(HomeCookingSpeedSkill)); // check below for annotation
            // how long it will take to craft the item , the recipe name again ,           change this to recipe name     (time taken)
            this.Initialize("WeetaBix", typeof(WeetaBixRecipe));
