namespace Eco.Mods.TechTree
{
    ...
    [Serialized]
    [Weight(300)]
    public partial class ThaiRiceWithSalmonItem : //Name of the item in unity @DO NOT CHANGE USE A DIFFERENT NAME FROM THE UNITY VERSION
        FoodItem
    {
        public override string FriendlyName                     { get { return " Thai Rice With Salmon"; } }  // name given and seen when scrolling through the ingame menus
        public override string Description                      { get { return "Delicous Thai Rice with freshly cooked salmon "; } } // item description upon hovering over an item

        private static Nutrients nutrition = new Nutrients()    { Carbs = 74, Fat = 48, Protein = 40, Vitamins = 15}; // The effects of eating the item for example mashed potatoe would have more carbs than protein where as steak would be the reverse !!Balance is vital!!
        public override float Calories                          { get { return 857; } } // Number of calories the food will give you >> thew more complicated and resources intesive the recipe the more ballanced and more calories it should give
    ...
    public partial class ThaiRiceWithSalmonRecipe : Recipe // "ThaiRiceWithSalmonRecipe : Recipe" labels the name of the recipe that will be displayed in the workbench.
    {
        public ThaiRiceWithSalmonRecipe() // include the same name as the food you are attempting to create before recipe eg, yourfoodrecipe()
        {
            this.Products = new CraftingElement[] // dont touch this
            {
                new CraftingElement<ThaiRiceWithSalmonItem>(), //This is what the recipe will produce this one should be the name of your fooditem
